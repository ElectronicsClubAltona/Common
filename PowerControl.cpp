...
void CPowerManager::setPin18ISR(GlobalFunctionPtrType pISR, const uint8_t nMode)
{
	m_pPin18ISR = pISR;
	m_nINT3Mode = nMode;
}

void CPowerManager::setPin19ISR(GlobalFunctionPtrType pISR, const uint8_t nMode)
{
	m_pPin19ISR = pISR;
	m_nINT2Mode = nMode;
}

void CPowerManager::setPin20ISR(GlobalFunctionPtrType pISR, const uint8_t nMode)
{
	m_pPin20ISR = pISR;
	m_nINT1Mode = nMode;
}

void CPowerManager::setPin21ISR(GlobalFunctionPtrType pISR, const uint8_t nMode)
{
	m_pPin21ISR = pISR;
	m_nINT0Mode = nMode;
}
...
void CPowerManager::addDevice(CDevice *pDevice)
{
